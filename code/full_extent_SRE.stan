...
//---
//--- Stan code for the full extent model with conditional autoregressive
//--- spatial random effects. See Appendix 1 for a description of the 
//--- parameterizations used here. Note that Z' = Z_ , PSI' = PSI_ , etc
